...
# Solapamiento de distribuciones normales
# ============================================================

# ---- Locale (evita problemas UTF-8 con htmlwidgets) ---------
...
p <- plot_ly() %>%
  ...
  layout(
    ...
    title = "Solapamiento de Distribuciones en Datos REGULARES",
    xaxis = list(title = "Variables de Procesos A y B"),
...
saveRDS(
  p,
  file = "p5_solapamiento_distribuciones_normales.rds"
)
